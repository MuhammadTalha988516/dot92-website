  ...
  return (
    <div className="flex flex-col min-h-screen relative">
      ...
      <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
        {/* Static background image covering full window */}
        <img
          src={RFImage}
      ...
      {/* Cards Section */}
      <section className="w-full max-w-7xl mx-auto py-12 sm:py-16 md:py-24 px-4 sm:px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-12 md:gap-20">
